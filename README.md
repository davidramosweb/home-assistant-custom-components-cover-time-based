...
Optional settings:
- `send_stop_at_ends` defaults to False. If set to `True`, the Stop script will be run after the cover reaches any of the end positions. This may be needed to release the relays when position is 0 or 100.
