...
You can adapt it to your requirements, actually any cover system could be used which uses 3 triggers: up, stop, down. The idea is to embed your triggers into scripts which can be hooked into this component with Home Assistant scripts. For example, you can use RF-bridge or a dual-gang switch running Tasmota firmware integrated like in the examples shown below.
